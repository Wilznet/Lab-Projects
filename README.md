...
The .pkt file (open it and everything works)
Topology screenshot
Final running-configs for all routers
Quick verification commands

Feel free to clone and use for your own study. No fancy stuff, just labs that work.
